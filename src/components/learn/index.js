    ...
    <div className="learn-wrapper flex">
      <div className="learn-wrapper-comments flex flex-column">
        ...
        <div className="learn-wrapper-comments-content">
          ...
          options for our ballers, but only 10,000 will be made. All players
          will be randomly generated, this means no 2 players will be the same.
          We have a unique ranking system, some ballers might be better than
